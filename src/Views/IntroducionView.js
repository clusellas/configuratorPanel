    ...
    return (
        <Box
            sx={{
                ...
                alignItems: "center",
                height: "100vh",
                backgroundImage: 'url("tu-imagen-de-fondo.jpg")', // Asegúrate de añadir una imagen de fondo
        ...
        >
            <Box
                sx={{
                    ...
                    right: 0,
                    bottom: 0,
                    background: "rgba(0, 0, 0, 0.6)", // Cambié la opacidad para una mejor legibilidad
                    zIndex: 1,
                }}
            />
            ...
            <Box sx={{ zIndex: 2 }}>
                <Typography
                    ...
                    sx={{
                        color: "white",
                        fontWeight: "bold",
                        textShadow: "2px 2px 6px rgba(0, 0, 0, 0.8)", // Mejoré el efecto de sombra
                ...
                <Typography
                    ...
                    sx={{
                        color: "white",
                        textShadow: "1px 1px 4px rgba(0, 0, 0, 0.8)", // Mejoré el efecto de sombra
                        animation: "fadeIn 1.5s", // Animación de entrada
                    }}
                >
                ...
                <Typography
                    ...
                    sx={{
                        ...
                        mt: 3,
                        textShadow: "1px 1px 4px rgba(0, 0, 0, 0.8)", // Mejoré el efecto de sombra
                        textAlign: "center", // Asegurando que el texto esté centrado
                        marginLeft: "auto", // Alineación automática a la izquierda y derecha
                        marginRight: "auto",
    ...
    return (
        ...
        >
            ...
            <Box sx={{ zIndex: 2 }}>
                ...
                >
                    Bienvenido al Configurador 3D de Decosan
                </Typography>
